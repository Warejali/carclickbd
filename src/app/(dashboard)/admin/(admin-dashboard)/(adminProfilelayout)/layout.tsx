...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navItems = [
    { path: "/admin/profile", label: "User Details / Update", icon: <UserOutlined /> },
    { path: "/admin/profile/account-history", label: "Account History", icon: <HistoryOutlined /> },
    { path: "/admin/profile/change-password", label: "Change Password", icon: <LockOutlined /> },
    { path: "/admin/profile/change-picture", label: "Change Profile Picture", icon: <PictureOutlined /> },
  ];

  return (
    <div className="bg-gray-50 min-h-screen">
      {!profileInfo?.isEmailVerified && <EmailVerificationAlert />}
      <div className="container mx-auto py-6 px-4">
        ...
        <div className="grid grid-cols-12 gap-6 mt-6">
          <Card className="col-span-12 md:col-span-3 p-4 shadow-lg lg:min-h-screen">

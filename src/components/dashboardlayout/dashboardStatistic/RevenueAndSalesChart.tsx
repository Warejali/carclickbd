...
const RevenueAndSalesChart: React.FC = () => {
  const series = [
    {
      name: "Product One",
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
        ...
        <div className="flex w-full max-w-45 justify-end">
          <div className="inline-flex items-center rounded-md bg-slate-200 p-1.5  ">
            <button className="rounded bg-white px-3 py-1 text-xs font-medium text-black shadow-md   hover:shadow-lg     ">
              Day
            </button>
            <button className="rounded px-3 py-1 text-xs font-medium text-black hover:bg-white hover:shadow-lg">
              Week
            </button>
            <button className="rounded px-3 py-1 text-xs font-medium text-black hover:bg-white hover:shadow-lg ">
              Month
